...
class P0238_ProductOfArrayExceptSelfTest {
    ...
    @Test
    void productExceptSelfNaive_example1() {
        assertArrayEquals(new int[]{24, 12, 8, 6}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{1, 2, 3, 4}));
    }

    @Test
    void productExceptSelfNaive_example2() {
        assertArrayEquals(new int[]{0, 0, 9, 0, 0}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{-1, 1, 0, -3, 3}));
    }

    @Test
    void productExceptSelfNaive_commentWalkthrough() {
        assertArrayEquals(new int[]{48, 24, 12, 8}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{1, 2, 4, 6}));
    }

    @Test
    void productExceptSelfNaive_twoElements() {
        assertArrayEquals(new int[]{7, 3}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{3, 7}));
    }

    @Test
    void productExceptSelfNaive_singleZero() {
        assertArrayEquals(new int[]{0, 0, 24, 0}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{2, 3, 0, 4}));
    }

    @Test
    void productExceptSelfNaive_twoZeros() {
        assertArrayEquals(new int[]{0, 0, 0, 0}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{2, 0, 0, 4}));
    }

    @Test
    void productExceptSelfNaive_allNegative() {
        assertArrayEquals(new int[]{-24, -12, -8, -6}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{-1, -2, -3, -4}));
    }

    @Test
    void productExceptSelfNaive_mixedSigns() {
        assertArrayEquals(new int[]{-6, 6, 3, -2}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{-1, 1, 2, -3}));
    }

    @Test
    void productExceptSelfNaive_allOnes() {
        assertArrayEquals(new int[]{1, 1, 1, 1}, P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(new int[]{1, 1, 1, 1}));
    }

    @Test
    void productExceptSelfNaive_doesNotMutateInput() {
        int[] nums = {1, 2, 3, 4};

        P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(nums);

        assertArrayEquals(new int[]{1, 2, 3, 4}, nums);
    }

    @Test
    void productExceptSelfNaive_matchesBruteForceOnRandomInput() {
        Random random = new Random(238);
        for (int t = 0; t < 200; t++) {
            int[] nums = randomArray(random);

            assertArrayEquals(bruteForce(nums), P0238_ProductOfArrayExceptSelf.productExceptSelfNaive(nums));
        }
    }
    ...
    void productExceptSelf_doesNotMutateInput() {
        ...
        P0238_ProductOfArrayExceptSelf.productExceptSelf(nums);
