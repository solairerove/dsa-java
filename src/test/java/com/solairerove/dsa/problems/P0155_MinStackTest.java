...
class P0155_MinStackTest {
    ...
    @Test
    void followsLeetCodeExampleLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void minUpdatesOnDescendingPushesLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void minStaysOnAscendingPushesLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void minRestoredAfterPopsLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void duplicateMinsHandledLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void reusableAfterEmptyingLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void topDoesNotRemoveLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
    ...
    @Test
    void negativeAndPositiveMixLinkedList() {
        P0155_MinStack.MinStackLinkedList stack = new P0155_MinStack.MinStackLinkedList();
